...
function AboutHeader({ data }) {
  return (
    <div className="text-center">
      ...
      <h2 className="mt-3 text-[28px] font-normal leading-tight text-brand-ink sm:mt-4 sm:text-4xl md:text-5xl lg:text-6xl xl:mt-[12px] 2xl:mt-[10px] 2xl:text-[51px] 2xl:leading-[1.26] 2xl:tracking-[-0.04em]">
        {data.titleLineOne}{' '}
